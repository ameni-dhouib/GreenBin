...
🔔 Automatic Notifications — Alerts when containers are full or incidents occur on routes
🛣️ Smart Route Planning — Optimize collection tours based on fill levels, vehicle capacity, and staff availability
👷 Employee Management — Auto-assign agents to zones based on availability and skills
📄 XML/XSD Data Exchange — Generate, import, and export structured reports for inter-service interoperability
...
git clone https://github.com/ameni-dhouib/GreenBin.git
...
Employe — Field agents with availability and skill profiles
Tournee — Optimized collection tours with route, zones, and CO₂ reporting


📄 License
This project was developed as part of an academic assignment at ISIMS — AU 2025-2026.
